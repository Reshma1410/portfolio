            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                <a
                  ...
                  className="flex items-center text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-300"
                >
                  <Mail className="w-6 h-6 mr-3 text-purple-600" />
                  reshureshma1410@gmail.com
                </a>
                <a
                  href="tel:+917373640482"
                  className="flex items-center text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-300"
                >
